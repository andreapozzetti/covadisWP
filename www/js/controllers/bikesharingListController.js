...
angular.module('BikesharingListCtrl', [])
.controller('bikesharingListCtrl', function($scope, $routeParams, $window, $location, $timeout, parking, bikesharing, goBack) {
  ...
  $scope.bikesharingList = bikesharing.getAllBikesharing().then(function(data) {
    $scope.loading = true;
    $scope.bikesharingList = data;
    return $scope.bikesharingList;
  });
  ...
  $scope.bikesharingInfo = function(idBikesharing){
      $location.path("/bikesharing/"+idBikesharing);
  }
